...
class_weight = list('0' = 1, '1' = 1.42)



model %>% compile(
  loss = 'categorical_crossentropy',
  optimizer = optimizer_adam(lr = 0.0017, beta_1 = 089),
  metrics = "accuracy"
)
...
caret::confusionMatrix(predicted, true)
...
# Sensitivity : 0.96539         
# Specificity : 0.07021         
# Pos Pred Value : 0.97853         
# Neg Pred Value : 0.04418         
# Prevalence : 0.97773         
# Detection Rate : 0.94389         
# Detection Prevalence : 0.96460         
# Balanced Accuracy : 0.51780         
# 
# 'Positive' Class : 0               
